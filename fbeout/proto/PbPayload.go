...
func NewPbPayload() *PbPayload {
    return &PbPayload{
        ...
        Chart: make(map[string]int32),
        SubShop: *NewSubStruct(),
    }
}

// Create a new PbPayload struct from the given field values
func NewPbPayloadFromFieldValues(StringEntry string, SmallInteger int32, NormalInteger int64, SerializationMethod string, Boolean bool, SomeFloat float32, IntArray []int32, Chart map[string]int32, SubShop SubStruct) *PbPayload {
