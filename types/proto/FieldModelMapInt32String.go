...
// Fast Binary Encoding Int32->String map field model
type FieldModelMapInt32String struct {
	// Field model buffer
	buffer *fbe.Buffer
...
// Create a new Int32->String map field model
func NewFieldModelMapInt32String(buffer *fbe.Buffer, offset int) *FieldModelMapInt32String {
	fbeResult := FieldModelMapInt32String{buffer: buffer, offset: offset}
...
// Get the field size
func (fm *FieldModelMapInt32String) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapInt32String) FBEExtra() int {
...
func (fm *FieldModelMapInt32String) FBEOffset() int { return fm.offset }

// Set the field offset
func (fm *FieldModelMapInt32String) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapInt32String) FBEShift(size int) { fm.offset += size }

// Unshift the current field offset
func (fm *FieldModelMapInt32String) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapInt32String) Offset() int {
	if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
		return 0
	}
...
// Get the map size
func (fm *FieldModelMapInt32String) Size() int {
	if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
		return 0
	}
...
// Map index operator
func (fm *FieldModelMapInt32String) GetItem(index int) (*fbe.FieldModelInt32, *fbe.FieldModelString, error) {
	if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32String) Resize(size int) (*fbe.FieldModelInt32, *fbe.FieldModelString, error) {
...
func (fm *FieldModelMapInt32String) Verify() bool {
	if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
		return true
	}
...
// Get the map
func (fm *FieldModelMapInt32String) Get() (map[int32]string, error) {
...
// Set the map
func (fm *FieldModelMapInt32String) Set(values map[int32]string) error {
	if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
