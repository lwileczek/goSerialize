...
// Fast Binary Encoding String->Int32 map field model
type FieldModelMapStringInt32 struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    modelValue *fbe.FieldModelInt32
}

// Create a new String->Int32 map field model
func NewFieldModelMapStringInt32(buffer *fbe.Buffer, offset int) *FieldModelMapStringInt32 {
    fbeResult := FieldModelMapStringInt32{buffer: buffer, offset: offset}
    fbeResult.modelKey = fbe.NewFieldModelString(buffer, offset)
    fbeResult.modelValue = fbe.NewFieldModelInt32(buffer, offset)
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapStringInt32) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapStringInt32) FBEExtra() int {
...
func (fm *FieldModelMapStringInt32) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapStringInt32) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapStringInt32) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapStringInt32) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapStringInt32) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapStringInt32) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapStringInt32) GetItem(index int) (*fbe.FieldModelString, *fbe.FieldModelInt32, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapStringInt32) Resize(size int) (*fbe.FieldModelString, *fbe.FieldModelInt32, error) {
...
func (fm *FieldModelMapStringInt32) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapStringInt32) Get() (map[string]int32, error) {
...
// Set the map
func (fm *FieldModelMapStringInt32) Set(values map[string]int32) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
